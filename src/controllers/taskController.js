...
const Notification = require("../models/Notification"); // Bildirim modeli eklendi
...
const addAssignee = async (req, res, next) => {
    try {
        ...
        // BİLDİRİM GÖNDERME EKLENDİ - SORUNUN ÇÖZÜMÜ BURADA
        await Notification.create({
            user_id: user_id,
            content: `Bir göreve atandınız: "${task.title}"`,
